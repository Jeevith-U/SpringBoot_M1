package com.SpringBoot_1.SpringBoot_1.configuration;
...
public class SwaggerConfig {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		contact.setEmail("info@car.in");
		contact.setName("Car_Booking");
		contact.setUrl("https://www.CarBookKaro.in");

		License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

		Info info = new Info().title("Car_Booking RESTful Web Service documentation").version("1.0")
